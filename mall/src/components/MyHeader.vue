    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="小冷松科技官网">Chimelu</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              <router-link to="" style="text-decoration: none; color: #fcfcfc" v-if="user.account !== '' && user.account !== null">{{user.account}}, 你好！</router-link>
              <el-dropdown>
                <el-button>
                  更多菜单<i class="el-icon-arrow-down el-icon--right"></i>
                </el-button>
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item><router-link to="/user/orderList" class="more">我的订单</router-link></el-dropdown-item>
                  <el-dropdown-item><router-link to="/user/information" class="more">账号资料</router-link></el-dropdown-item>
                  <el-dropdown-item><router-link to="/user/addressList" class="more">收货地址</router-link></el-dropdown-item>
                  <el-dropdown-item><router-link to="/user/support" class="more">售后服务</router-link></el-dropdown-item>
                  <el-dropdown-item><router-link to="/user/coupon" class="more">我的优惠</router-link></el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
              <el-badge :value="200" :max="99" style="margin: 35px">
                <el-button>购物车</el-button>
              </el-badge>
              <el-button v-if="user.account === null || user.account === ''">登录</el-button>
              <el-button v-if="user.account !== null && user.account !== ''" @click="_loginOut">退出登录</el-button>
            </div>
          </div>
        </div>
      </header>
...
<script>
  ...
  export default {
    ...
    created () {
      const _this = this
      _this.user.account = getStore('account')
      console.log("account" + _this.user.account)
    },
    data () {
      return {
        user: {
