...
export const userInfo = (params) => {
  return http.fetchPost(`${baseUrl}/users/check`, params)
}
// 注册账号
export const register = (params) => {
  return http.fetchPost(`${baseUrl}/users/regist`, params)
}
// 上传图片
...
export const test100 = (params) => {
  return http.fetchGet(`${baseUrl}/111/222`, params)
}
